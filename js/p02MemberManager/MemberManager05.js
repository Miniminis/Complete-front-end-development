...
$(document).ready(function(){
    ...
    $('#btn').click(function(){
            window.open("MemberManager05_editform.html", "editform", "width=500; height=500");
        });
...
function editMember(index){
    ...
    //외부 수정창 띄우기
    var editWindow = window.open("MemberManager05_editform.html", "Edit Member Info", "width=500; height=500");

    //alert(editWindow.$('#newUId'));
    //editWindow.$('#newUId').val('왜안나와');
    var p = $('#parent').val();
    var nid = editWindow.$('#newUId');
    nid.val(p);
    //editWindow.$('#newUPw').val(members[index].userpw);
    //editWindow.$('#newUName').val(members[index].username);
    //editWindow.$('#newIndex').val(index);
